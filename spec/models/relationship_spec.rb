    ...
    context '失敗' do
      ...
      context 'monitored_idが' do
        ...
        it '3件以上と被る場合にバリデーションが機能してinvalidになるか' do
          relationship = create(:relationship)
          create(:relationship, monitored_id: relationship.monitored_id)
          create(:relationship, monitored_id: relationship.monitored_id)
          relationship_with_duplicated_3_monitored = build_stubbed(:relationship, monitored_id: relationship.monitored_id)
